...
class TalkManager {
        ...
        func gakuseiOfLabel() -> (String,Int) {
                ...
                case 85...87:
                        return("普通男　ちょっとでも結果だしたのは評価できるな\nメガネ男  ３ヶ月ぐらいやって全く効果なかったらクソだろ。\nデカ男  最初は伸びしろがある分、成長が分かりやすいから本当に大変なのは今からだぞ。", 0)
                case 88...90:
                ...
                case 121...123:
                        return("普通男  まぁでも俺は実は、\(name)のこと根はいいやつって思ってたけど。\nメガネ男  はい、嘘。\nデカ男  昔の\(name)は知らんが今の\(name)はまぁいいやつだしな。", 0)
                ...
                default:
                        return ("最後まで一緒に頑張ってくれて本当にありがとうございます。これからは私がいなくても一人で努力できるよね？もちろん私は〇〇のこと応援し続けるよ",180)
                }
