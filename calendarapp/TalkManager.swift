...
//                defaults.set(restdayArray, forKey: "restdayArray")
        ...
        func numberOfLabel() -> (String, UIImage,Int) {
               ...
               case 151:
                ...
                case 161:
                        return ("なんだか\(name)が遠い存在の人になってきちゃったな。",image25!,161)
                case 162:
        ...
        func  restOfLabel()->(String, UIImage,Int){
                ...
                case 21:
                        return ("\(name)は目標としている人っているの？いるならその人の真似をするといいかも。",image11!,428)
                case 22:
                        return ("ゆっくり休むのも大切だよね。",image15!,429)
                case 23:
                        return ("睡眠時間だけは削っちゃだめだよ。最低6時間は寝ること！",image22!,430)
                case 24:
                        return ("意外と努力してる人って、何か趣味とかで息抜きの時間があったりするみたいだよ。",image14!,431)
                        
                case 25:
                        return ("自分の時間も少しは確保しないとね。",image10!,432)
                case 26:
                        return ("雨の音が集中するのにいいみたいだよ。アプリでも聴けるからよかったら試してみて。",image15!,433)
                case 27:
                        return ("どうしてお休みの日ってお腹が減るんだろうね？私だけかな？",image20!,434)
                case 28:
                        return ("息抜きの甘い物は最高に美味しいね。",image6!,435)
                case 29:
                        return ("お休みだー。マイペースに行くのも大事だよ。",image21!,436)
                        
                case 30:
                        return ("私がお勧めした集中力UPの方法は興味がなかったらスルーしてね。",image18!,437)
                case 31:
                        return ("今日はお休みだね。たこパーしようよ。",image17!,438)
                case 32:
                        return ("努力で自分の運命は変えられるのか、努力できることが運命なのかどっちなんだろうね？",image11!,439)
                case 33:
                        return ("「達成できなかった」と、「本日はお休み」の違いが分からないって？雰囲気でいいよー（笑）",image6!,440)
                case 34:
                        return ("いい加減目覚めなさい。ふふ（笑）",image1!,441)
                case 35:
                ...
                case 38:
                        return ("今日はお休み？なら一緒にドリフ見ようよ〜。",image14!,445)
                case 39:
                        return ("\(name)、何か面白い話してよー。",image3!,446)
                        
                case 40:
                        return ("頑張った分だけお休みの日って充実するね。",image18!,447)
                case 41:
                        return ("毎日お休みはダメだからね（笑）",image13!,448)
                case 42:
                        return ("明日は頑張るンゴ。",image17!,449)
                case 43:
                        return ("\(name)は友達の友達と遊べるタイプ？私は全然大丈夫だよー。",image8!,450)
                case 44:
                        return ("休みの日って無性に部屋を掃除したくなるね。",image24!,451)
                case 45:
                        return ("今日はお休みだねー。何をしようかなー？",image5!,452)
                case 46:
                        return ("成果が出ない時って周りの目なんか気にならないっていったら嘘になるけど、気にしないようにした方がいいかも。",image10!,453)
                case 47:
                        return ("幸せは〜歩いてこない〜だ〜から、ラランララランララー♪",image8!,454)
                case 48:
                        return ("無駄じゃないよ〜経験したすべ〜て♪",image17!,455)
                case 49:
                        return ("\(name)と一緒にのんびり過ごすのも楽しいな。",image18!,456)
                        
                case 50:
                        return ("私たちって絶対やればできるんだよ（笑）",image17!,457)
