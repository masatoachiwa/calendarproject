...
//                defaults.set(restdayArray, forKey: "restdayArray")
        ...
        func numberOfLabel() -> (String, UIImage,Int) {
               ...
               case 16:
                ...
                case 17:
                        return ("あーごめん笑。結局\(effort)やってない。私は小さい頃からピアノをずっと続けられているからいいの笑",image18!,17)
                case 18:
                        return ("お疲れ様。今日も飽きずに\(effort)できたね。",image17!,18)
                case 19:
                        return ("最近\(name)が頑張っても雨降らなくなったね笑",image1!,19)
                case 20:
                        return( "２０日達成したよー。へい、へーい！",image20a!,20)
                case 21:
                        return ("もうすぐ１ヶ月だねー。なんだかしみじみするね。",image7!,21)
                case 22:
                ...
                case 27:
                        return ("お疲れ、今日は何時まで\(effort)してたの？",image1!,27)
                case 28:
                ...
                case 31:
                        return ("まだまだこれからだよ！うん。",image10!,31)
                case 32:
                        return ("やっぱり努力してる人って素敵だな。",image5!,32)
                case 33:
                        return ("もうすぐ定期試験だね。二足のわらじも大変だけど頑張ろ。",image6!,33)
                case 34:
                        return ("やっぱり定期試験の勉強との両立って難しいよね。できる\(name)のこと尊敬するなー。",image15!,34)
                case 35:
                        return("今日は私疲れちゃって全然勉強できなかったー。\(name)と違って私だめだなー。",image16!,35)
                case 36:
                        return ("今日もお疲れ様！明日は定期テストだよ。",image5!,36)
                case 37:
                        return ("定期テストできたの？\(effort)しながらよく頑張ったね。",image2!,37)
                case 38:
                        return ("\(name)ってさあ、\(effort)始める前よりもテストの点あがってない？",image11!,38)
                case 39:
                        return ("一つのことを努力する習慣がつくと、他のこともできるようになるのかな？",image14!,39)
                case 40:
                        return ("クラスメートも\(name)が変わったことに気がつき始めたかもね。",image18!,40)
                case 41:
                        return ("私は最初から\(name)はやればできるって知ってたよ。",image10!,41)
                case 42:
                        return ("お疲れ様、本当にすごいね。\(name)の集中力を分けて欲しいよ。",image20!,42)
                case 43:
                ...
                case 52:
                        return ("だから後１３０日！道のりは長いよ！",image22!,52)
                case 53:
                        return ("\(name)なら絶対できるよ！",image24!,53)
                case 54:
                        return ("もう\(effort)しないと気持ち悪いんじゃない？",image16!,54)
                case 55:
                        return ("不思議だね。私も\(name)が今日は\(effort)してないって聞くと、何かあったの？って思うようになっちゃった。",image2!,55)
                case 56:
                        return ("なんだか\(name)の頑張ってる姿を見ると私も嬉しくなっちゃう。",image7!,56)
                case 57:
                ...
                case 70:
                        return ("\(effort)を続けて思うような結果がでなかったらどうしようとか、そんなことを考えたりはしてないよね？",image25!,70)
                case 71:
                        return ("他には、どうせうまくいかないから頑張っても意味ないんじゃないか、とかね。",image23!,71)
                case 72:
                        return ("私がそうだったから...\(name)も同じ悩みを抱えていないか心配だったの。",image9!,72)
                case 73:
                        return ("でもここまで続けてきた\(name)ならきっとうまくいくよ。",image16!,73)
                case 74:
                        return ("それに私が応援しているんだから絶対に大丈夫（笑）",image17!,74)
                case 75:
                        return ("あっーー！今日で\(effort)始めてから達成できた日が75日経ってる。70日目伝えるの忘れてた。",image8!,75)
                case 76:
                        return ("看板もう描いちゃってたから許してね。正しくは76日目達成！",image70a!,76)
                case 77:
                        return ("私が\(name)の努力した日数を毎日ちゃんと数えてるからね！",image5!,77)
                case 78:
                ...
                case 89:
                        return ("私は仮眠するとそのまま朝まで寝ちゃうから、向いてない人もいるけど。",image20!,89)
                case 90:
                        return ("９０日おめでとう！あっという間だった？長かった？何はともわれ残り９０日！",image90a!,90)
                case 91:
                        return ("今日もお疲れ様。３ヶ月あっという間だったなー。",image7!,91)
                case 92:
                        return ("折り返し地点を過ぎたって考えると残りはもうすぐだね。",image10!,92)
                case 93:
                        return ("なんだか最後までやり終えた\(name)を想像するとワクワクするね。",image5!,93)
                case 94:
                        return ("絶対に最後まで応援するからよろしくね。",image15!,94)
                case 95:
                        return ("お疲様、本当に\(name)が毎日楽しそうで羨ましい。",image17!,95)
                case 96:
                        return ("クラスの友達も最近\(name)の顔つきが変わった？って言ってたよ。",image2!,96)
                case 97:
               ...
               case 99:
                ...
                case 100:
                        return ("おめでとう！１００日目だよ。ついに３桁いきましたね。",image100a!,100)
                case 101:
                        return ("もう\(effort)し続けることは苦にならないよね？",image12!,101)
                case 102:
                        return ("今日も１日お疲れ様です。これ飲んで休憩しよ。",image4!,102)
                case 103:
                        return("私正直いうとね、\(effort)一週間でやめると思っていたんだよ。",image13!,103)
                case 104:
                        return ("これだけ続けていられるのは本当に\(name)が変わろうと決心したからだよ。",image10!,104)
                case 105:
                        return ("それと少しは私のお陰もあるのかな？",image15!,105)
                case 106:
                        return ("嘘々、全部\(name)の力だよ。私は応援してるだけですから。",image18!,106)
                case 107:
                ...
                case 110:
                        return ("ジャーン！１１０日経ったよ！あと７０日だね。",image110a!,110)
                case 111:
                        return ("そう言えば私ね、一回だけピアノの練習をやめた時期があるんだ。",image25!,111)
                case 112:
                        return ("私より年下で私より後にピアノを始めたのに、本当に才能があるこですぐに抜かされたの。",image26!,112)
                case 113:
                        return ("だから練習するのがバカらしくなって休んだり、レッスンに行っても練習してないからすぐにバレたんだ。",image20!,113)
                case 114:
                        return ("それで先生にやめたいって言ったんだ。理由も正直に話したわ。",image13!,114)
                case 115:
                        return ("そしたら先生に「人と比べるんじゃなくて、昨日の自分を超えることを考えて」って言われたの。",image18!,115)
                case 116:
                        return ("先生は続けてこう言ったの。「人と比べるより、昨日の自分に勝つことができる子が伸びるの。",image18!,116)
                case 117:
                        return ("どんなに才能があっても、人と比べているだけで満足してたら絶対にどこかで止まるわ。",image18!,117)
                case 118:
                        return ("だから、自分に負けないで」って。それでもう一度やってみようと思ったんだ。",image17!,118)
                case 119:
                        return ("ごめんね。こんな話して、ちょっと嫉妬しちゃったんだ。毎日目標に向けて突っ走る\(name)を見て。",image16!,119)
                case 120:
                        return ("あっ、ごめん。今日で１２０日目だよ。いえーい！",image120a!,120)
                case 121:
                        return ("きっと\(name)は\(effort)の才能があるんだろうなー。",image13!,121)
                case 122:
                        return ("もし私みたいに、やめたい時期がきたら私に相談してくれると嬉しいな。",image9!,122)
                case 123:
                ...
                case 130:
                        return ("ジャジャジャジャーン！１３０日達成だよ！あと５０日。",image130a!,130)
                case 131:
                ...
                case 142:
                        return ("冗談だよ。半年の目標を達成させてから次は考えよ。",image17!,142)
                case 143:
                        return ("ねー。\(name)は好きな人とかいるの？",image3!,143)
                case 144:
                        return ("えっ。いいじゃん。聞いたって。",image10!,144)
                case 145:
                        return ("逆に私はどうかって？うーん。いるよ。",image12!,145)
                case 146:
                        return ("へへ、誰かは秘密。そのうち教えてあげてもいいけど、今は恥ずかしいな。",image3!,146)
                case 147:
               ...
               case 151:
                ...
                case 155:
                        return( "今日もお疲れ様！このセリフ何回ぐらい言ったんだろうね？",image15!,155)
                case 156:
                ...
                case 163:
                        return ("すごいよ。もうゴールが近いのにどんどん集中力が上がってきてるね。",image7!,163)
                case 164:
                        return ("今日もお疲れ様！最後の最後までこのまま駆け抜けて。",image6!,164)
                case 165:
                        return ("ここだけの話、\(name)の努力する姿を見ていると私の方が励みになっているんだよ。",image12!,165)
                case 166:
                        return ("不思議だね。応援している私の方が力をもらっちゃうなんて。",image7!,166)
                case 167:
                        return( "\(name)の頑張る姿を見るたびに私も頑張ってたんだよ。私も褒めてー。",image17!,167)
                case 168:
                        return ("自分より努力してる人に褒められると、嬉しいな。",image8!,168)
                case 169:
                        return( "そういえば覚えてる？ゴールになったら私の好きな人いう話？",image16!,169)
                case 170:
                        return ("１７０日達成！ラスト１０日！いよいよだね。",image170a!,170)
                case 171:
               ...
               case 179:
                       return ("ラスト１日！本当にお疲れ様！私に素敵な体験をさせてくれてありがとう。",image17!,179)
                case 180:
                       return ("180日達成おめでとう。\(name)のことが大好きです。",image19!,180)
        ...
        func  badOfLabel()->(String, UIImage,Int){
                if currentTotalPoint <= 5 {
                        ...
                        default:
                           ...
                           case 9:
                                return( "疲れちゃった？たまにはそんな日もあっていいと思うよ。",image11!,212)
                           case 10:
                                return ("私は信じてるから諦めないでね。",image7!,213)
                           case 11:
                                return ("\(name)なら絶対やり遂げられるよ。",image24!,214)
                           case 12:
                                return ("頑張って5分だけやってみると意外とそこからやり続けちゃうよ。",image14!,215)
                           case 13:
                                return ("どんまい。そんな日もあるよ。",image26!,216)
                           case 14:
                                return ("今日できなかったことよりも、明日再開することが大事だよ。",image12!,217)
                           case 15:
                          ...
                          case 16:
                           ...
                           case 18:
                                return ("ファイト！始めた時の\(name)の目は本気だったよ、もう一回頑張ろ。",image10!,221)
                           case 19:
                                return ("今日はたまたまだよね？",image23!,222)
                           case 20:
                                return ("もしかしてやめようとしてる？",image25!,223)
                           case 21:
                                return ("まあ、そんなもんだと思ったよ。",image18!,224)
                           case 22:
                                return ("もう一回頑張ったら？",image23!,225)
                           case 23:
                                return ("本当にやめるの？",image26!,226)
                           case 24:
                                return ("それで納得できるの？",image25!,227)
                           case 25:
                                return ("最後までやりとげる\(name)見たかった...。",image9!,228)
                           case 26:
                           ...
                           case 29:
                                return ("やめることは\(name)の自由だけどね...。",image26!,232)
                           case 30:
                ...
                return ("バイバイ！",image29!,239)
                        ...
                        case 11:
                                return ("\(name)なら絶対やりとげられるよ。",image24!,250)
                        case 12:
                        ...
                        case 15:
                                return ("人間なんだからたまにはさぼらなくっちゃ！",image17!,254)
                        case 16:
                        ...
                        case 29:
                                return ("毎日続けるって意外と難しいよね。でも\(name)はできるよ。",image12!,268)
                        case 30:
                        ...
                        case 39:
                                return ("ジュースごちそうさまです（笑）",image21!,278)
                        case 40:
                        ...
                        case 51:
                                return ("もしかしてやめようとしてる？",image25!,290)
                        case 52:
                                return ("根性よ！\(name)根性！",image27!,291)
                        case 53:
                                return ("もう一回頑張ったら？",image23!,292)
                        case 54:
                                return ("本当にやめるの？",image26!,293)
                        case 55:
        ...
        }else if currentTotalPoint  >= 101 && currentTotalPoint <= 9999{
        switch currentTotalbadPoint {
        ...
        case 2:
        return ("あわてないあわてない。",image2!,304)
        case 3:
        return ("一休み、一休み。",image4!,305)
        case 4:
        ...
        case 29:
        return ("毎日続けるって意外と難しいよね。でも\(name)はできるよ。",image12!,331)
        case 30:
        return ("ちょっとサボりぐせ出てきたぞー、ファイトだよ。",image6!,332)
        case 31:
        ...
        case 39:
        return( "ジュースごちそうさまです（笑）",image21!,341)
        case 40:
        ...
        case 49:
                return ("\(name)なら絶対やりとげられるよ。",image17!,351)
        case 50:
        ...
        case 66:
                return ("明日はやるんだよ！あ・し・た・は！",image22!,368)
        case 67:
                return ("\(effort)をする前にストレッチをすると良いかも。",image6!,369)
        case 68:
                return ("やめたいって思うのはみんなあるけど、そこでやめないことで成長できると思うよ。",image16!,370)
        case 69:
                return ("１日のノルマを少なくして、毎日達成できた実感を得る作戦にしてもいいかも。",image11!,371)
        case 70:
                return ("こんなところで止まっちゃダメだよ。突き抜けて。",image24!,372)
        case 71:
        ...
        case 74:
                return ("絶対に最後までやりとげよう。諦めちゃダメだよ",image26!,376)
        case 75:
        ...
        case 81:
                return (" ここからは自分との勝負だよ。",image9!,383)
        case 82:
        ...
        case 89:
        return ("ファイト！\(effort)始めた時の\(name)の目は本気だったよ、もう一回がんばろ。",image10!,391)
        case 90:
        return ("やっぱり...辛いの？",image26!,392)
        case 91:
        return ("もしかしてやめようとしてる？",image25!,393)
        case 92:
        ...
        func  restOfLabel()->(String, UIImage,Int){
                ...
                case 14:
                        return ("あわてない、あわてない。一休み、一休み。",image18!,421)
                case 15:
                ...
                case 18:
                        return ("量より質っていうけど、ある程度の量を確保しないと質って保てないと思うんだー。",image14!,425)
                ...
                case 21:
                        return ("\(name)は目標としている人っているの？いるならその人の真似をするといいかも。",image13!,428)
                case 22:
                        return ("ゆっくり休むのも大切だよね。",image22!,429)
                case 23:
                        return ("睡眠時間だけは削っちゃだめだよ。最低6時間は寝ること！",image1!,430)
                case 24:
                        return ("意外と努力してる人って、何か趣味とかで息抜きの時間があったりするみたいだよ。",image6!,431)
                        
                case 25:
                        return ("自分の時間も少しは確保しないとね。",image18!,432)
                case 26:
                        return ("雨の音が集中するのにいいみたいだよ。アプリでも聴けるからよかったら試してみて。",image17!,433)
                case 27:
                        return ("どうしてお休みの日ってお腹が減るんだろうね？私だけかな？",image7!,434)
                case 28:
                        return ("息抜きの甘い物は最高に美味しいね。",image8!,435)
                case 29:
                        return ("お休みだー。マイペースに行くのも大事だよ。",image14!,436)
                        
                case 30:
                        return ("私がお勧めした集中力UPの方法は興味がなかったらスルーしてね。",image6!,437)
                case 31:
                        return ("今日はお休みだね。たこパーしようよ。",image18!,438)
                case 32:
                        return ("努力で自分の運命は変えられるのか、努力できることが運命なのかどっちなんだろうね？",image22!,429)
                case 33:
                        return ("「達成できなかった」と、「本日はお休み」の違いが分からないって？雰囲気でいいよー（笑）",image1!,430)
                case 34:
                        return ("いい加減目覚めなさい。ふふ（笑）",image6!,431)
                case 35:
                        return ("クラシックとかって本当に集中力あがるのかな？",image18!,432)
                case 36:
                        return ("豆柴のアイカ可愛いよね〜。知ってるかな？",image17!,433)
                case 37:
                        return ("「本日はお休み」を押すのは土日のことじゃなくて、\(name)のタイミングでいいからね。",image7!,434)
                case 38:
                        return ("今日はお休み？なら一緒にドリフ見ようよ〜。",image8!,435)
                case 39:
                        return ("\(name)、何か面白い話してよー。",image14!,436)
                        
                case 40:
                        return ("頑張った分だけお休みの日って充実するね。",image6!,437)
                case 41:
                        return ("毎日お休みはダメだからね（笑）",image18!,438)
                case 42:
                        return ("明日は頑張るンゴ。",image22!,429)
                case 43:
                        return ("\(name)は友達の友達と遊べるタイプ？私は全然大丈夫だよー。",image1!,430)
                case 44:
                        return ("休みの日って無性に部屋を掃除したくなる。",image6!,431)
                case 45:
                        return ("今日はお休みだねー。何をしようかなー？",image18!,432)
                case 46:
                        return ("成果が出ない時って周りの目なんか気にならないっていったら嘘になるけど、気にしないようにした方がいいかも。",image17!,433)
                case 47:
                        return ("幸せは〜歩いてこない〜だ〜から、ラランララランララー♪",image7!,434)
                case 48:
                        return ("無駄じゃないよ〜経験したすべ〜て♪",image8!,435)
                case 49:
                        return ("\(name)と一緒にのんびり過ごすのも楽しいな。",image14!,436)
                        
                case 50:
                        return ("私たちって絶対やればできるんだよ（笑）",image6!,437)
